...
export default function PrimaryButton({ label, className = "", href, onClick }) {
  const baseClasses = `rounded-[var(--radius\/main)] bg-liberatiRed text-white py-4 px-10 ${typeRole.button} transition-colors duration-300 hover:bg-white hover:text-black`;
